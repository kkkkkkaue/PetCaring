...
<html lang="pt-br">
    <head>
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-+0n0xVW2eSR5OomGNYDnhzAbDsOXxcvSN1TPprVMTNDbiYZCxYbOOl7+AMvyTG2x" crossorigin="anonymous">
        <title>PetCaring - Registrar Informação</title>
    </head>
    <body>
        <style>
            html, body {
        ...
        <br>
        <h3 id="tltDenuncia" >Registrar Informação</h3>
        <div class="row justify-content-center">
            <div class="row justify-content-center align-items-center w-50 border border-dark">
                <br>
                <form id="registroInfo" method="post" action="RegistrarInformacao">
                    <br>
                    <div class="col-15">
                        ...
                        <select id="formRegInfoTipo" name="tipoInformacao" class="form-select" required="">
                            ...
                            <option value="CuriosidadePets">Curiosidades</option>
                            <option value="DenunciaPets">Denúncia</option>
                        </select>
                    </div>
                    <br>
                    <div class="row">
