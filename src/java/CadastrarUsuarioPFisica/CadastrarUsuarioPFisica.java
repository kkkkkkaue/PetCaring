package CadastrarUsuarioPFisica;
...
public class CadastrarUsuarioPFisica extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String nome = request.getParameter("nomeCompletoPF");
            String apelido = request.getParameter("apelidoPF");
            String cpf = request.getParameter("cpfPF");
            String dtNasc = request.getParameter("dataNascimentoPF");
            String telCelular = request.getParameter("telefoneCelularPF");
            String cep = request.getParameter("cepPF");
            String estado = request.getParameter("estadoPF");
            String cidade = request.getParameter("cidadePF");
            String endereco = request.getParameter("enderecoPF");
            String numero = request.getParameter("numeroPF");
            String complemento = request.getParameter("complementoPF");
            String email = request.getParameter("emailPF");
            String senha = request.getParameter("senhaPF");
            String cargo = "pf";
            ...
            String sqlInsert = "INSERT INTO usuario (nome, apelido, email, senha, estado, cidade, endereco, numero, cep, complemento, telefone_celular, cargo) VALUES ('" + nome + "','" + apelido + "','" + email + "','" + passSHA512 + "','" + estado + "','" + cidade + "','" + endereco + "','" + numero + "','" + cep + "','" + complemento + "','" + telCelular + "','" + cargo + "')";
            ...
            if (rsLogin.next()) {
                ...
                String sqlInsertPf = "INSERT INTO pf (cpf, dt_nascimento, id_usuario) VALUES ('" + cpf + "','" + dtNasc + "','" + rsLogin.getString("id_usuario") + "')";
            ...
            HttpSession session = request.getSession();
            Logger.getLogger(CadastrarUsuarioPFisica.class.getName()).log(Level.SEVERE, null, ex);
